...
export default function StudentLogbook() {
  ...
  return (
    <div className="space-y-6" data-testid="student-logbook">
      <div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight">Digital Logbook</h1>
        <p className="text-sm text-muted-foreground mt-1">Record your daily industrial training activities.</p>
      </div>

      <div className="grid lg:grid-cols-5 gap-6">
        <form onSubmit={submit} className="lg:col-span-2 rounded-xl border border-border bg-card p-4 sm:p-6 space-y-4 h-fit">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button type="submit" className="w-full sm:w-auto" disabled={saving} data-testid="log-submit">{saving ? "Saving…" : editing ? "Update" : "Submit"}</Button>
