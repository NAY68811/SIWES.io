  ...
  return (
    <div className="space-y-6" data-testid="student-company">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">My Company</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <form onSubmit={submit} className="rounded-xl border border-border bg-card p-6 space-y-3">
          ...
          <Button type="button" variant="outline" onClick={useMyLocation} data-testid="use-my-location">Use my current location</Button>
          ...
          <Button type="submit" disabled={loading} data-testid="company-submit">
